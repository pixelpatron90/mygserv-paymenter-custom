            ...
            <form method="POST" action="{{ route('login') }}" id="login">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('social.login', 'apple') }}"
                        class="button button-secondary !flex gap-x-2 items-center justify-center">
                        <svg class="w-5 h-5 mr-2 text-secondary-900 dark:text-white" viewBox="0 0 21 20" fill="none"
                    ...
                    <a href="{{ route('social.login', 'github') }}"
                        class="button button-secondary !flex gap-x-2 items-center justify-center">
                        <svg class="w-5 h-5 mr-2 text-secondary-900 dark:text-white" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
